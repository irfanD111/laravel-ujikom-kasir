    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col">
                    <div class="col">
                        <div class="card text-bg-info mb-3" style="max-width: 23rem; width:19rem">
                            <div class="card-body">
                                <h5 class="card-title" style="color: white">{{$k}}</h5>
                                <svg xmlns="http://www.w3.org/2000/svg" width="65" height="63" fill="white" class="bi bi-people-fill position-absolute top-0 end-0  me-3 mt-3" viewBox="0 0 16 16">
                                    <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6m-5.784 6A2.24 2.24 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.3 6.3 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1zM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/>
                                  </svg>
                                  <p class="card-text" style="color: white">Jumlah Karyawan</p>
                            </div>
                            <div class="card-footer bg-border-info" style="background-color: rgb(35 118 135)"><a
                                    class="icon-link icon-link-hover link-light  link-offset-2 link-offset-3-hover link-underline link-underline-opacity-0"
                                    href="#">
                                    more info <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
