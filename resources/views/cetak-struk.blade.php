...
<body>
    ...
    <div class="struk">
        ...
        <p>----------------------------------------------------------------------------------------------------------------</p>        <div class="content">
            <div >
                <p>Tanggal Penjualan :{{ $penjualan->TanggalPenjualan }}</p>
                @foreach ($percobaan as $percobaan)
                <p>Nama Pelanggan :{{ $percobaan->NamaPelanggan }}</p>
                @break  
                @endforeach
                <p>Penjualan ID :{{ $penjualan->PenjualanID }}</p>
            </div>
            <p>----------------------------------------------------------------------------------------------------------------</p>
            <div class="item">
                <p><b>Nama Produk</b></p>
            ...
            <div class="item">
                <p>{{ $detail->NamaProduk }}</p>
                <p>{{ $detail->JumlahProduk }}</p>
                <p>{{ number_format($detail->SubTotal, 0, ',', '.') }}</p>
                <p>{{ number_format($detail->JumlahProduk * $detail->SubTotal, 0, ',', '.') }}</p>
            </div> @endforeach
            <p>----------------------------------------------------------------------------------------------------------------</p>
            <div class="total">
